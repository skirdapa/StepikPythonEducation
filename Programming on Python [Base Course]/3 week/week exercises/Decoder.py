...
code, key = input(), input()
to_code, to_decode = input(), input()


def decode(code, key, raw_string):
    decoder = dict((zip(key, code)))
    # print(decoder)
    decode_string = ''
    for i in raw_string:
        decode_string += decoder[i]
    return decode_string


print(decode(key, code, to_code))
print(decode(code, key, to_decode))
