...
with open("passwords.txt", 'r') as passwords:
    for one_pass in passwords:
        one_pass = one_pass.strip()  # Отщипляем знак переноса строки и тд
        print("Пробуем пароль:", one_pass)
        try:
            print(simplecrypt.decrypt(one_pass, encrypted).decode("utf-8"), '\n', f'Ура взломали!!! Пароль:  {one_pass}')
            break
        except simplecrypt.DecryptionException as e:
            print('неверный пароль, пробуем следующий', e.__str__())
