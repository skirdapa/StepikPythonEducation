...
а именно зарегистрироваться, создать приложение, и получить пару идентификаторов Client Id и Client Secret.
...
client_id = 'd382230b9cee2742e9bf'
client_secret_key = '43f6739babced6b5598b6c0e60aa0be4'
...
for artist in artists:
    ...
    r.encoding = 'utf-8'
    # print(r.json())
    bday = r.json()['birthday']
    name = r.json()['sortable_name']
    artist_bday_name.append(bday + ' ' + name)

print(artist_bday_name)

for artist in sorted(artist_bday_name):
    print(artist[5:])
